...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		L.EndModule();
		L.BeginModule("SRContainer");
		L.RegFunction("DlgWrapItem", SRContainer_DlgWrapItem);
		L.EndModule();
		L.EndModule();
		L.BeginPreLoad();
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int SRContainer_DlgWrapItem(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<SRContainer.DlgWrapItem>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<SRContainer.DlgWrapItem>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
